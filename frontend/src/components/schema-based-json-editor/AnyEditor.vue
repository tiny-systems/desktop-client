<template>
  <div :class="className">
    ...
    <code v-if="!schema.configure && !!expression" class="text-xs p-1 bg-indigo-50 dark:bg-indigo-900/50 text-indigo-600 dark:text-indigo-300 w-full block font-mono" v-text="expression"></code>
