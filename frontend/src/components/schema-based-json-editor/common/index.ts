...
export const largeTheme = {
  ...
  row: 'block pb-1',
  rowContainer: '',
  img: 'p-1 mt-1 w-full bg-white rounded-md border shadow-sm dark:bg-gray-900 border-gray-200 dark:border-gray-600',
...
export const smallTheme = {
  ...
  img: 'p-1 mt-1 w-full bg-white rounded-md border shadow-sm dark:bg-gray-900 border-gray-200 dark:border-gray-600',
  errorRow: 'border-red-500',
  button: 'px-2 py-2 cursor-pointer text-xs leading-4 font-medium rounded-md text-sky-700 bg-sky-100 enabled:hover:bg-sky-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 dark:bg-sky-600 enabled:dark:hover:bg-sky-500 dark:text-black disabled:opacity-50',
