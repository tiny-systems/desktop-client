<template>
  <div class="p-4">
    ...
    <div v-else-if="error && isCrdError" class="flex items-center justify-center min-h-64 py-8">
      <div class="w-full max-w-5xl mx-auto text-left px-4">
...
helm upgrade --install tinysystems-crd tinysystems/tinysystems-crd --namespace {{ props.ctx?.ns || 'default' }} --create-namespace</pre>
        </div>
